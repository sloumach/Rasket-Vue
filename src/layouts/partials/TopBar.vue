        ...
        <div class="d-flex align-items-center gap-2 topbar-left-container">
          ...
          <form class="app-search d-none d-md-block me-auto">
            <div class="position-relative">
              <input type="search" class="form-control" :placeholder="t('common.search') + '...'" autocomplete="off" value="">
          ...
          <DropDown class="topbar-item">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              <router-link class="dropdown-item text-danger" :to="{ name: 'auth.sign-in' }">
                <i class="bx bx-log-out fs-18 align-middle me-1"></i><span class="align-middle">{{ t('common.logout') }}</span>
              </router-link>
            </div>
          </DropDown>
        </div>
